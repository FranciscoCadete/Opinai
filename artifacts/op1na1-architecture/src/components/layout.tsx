...
import { Menu, X, BookOpen, Layers, Database, FileJson, Shield, FolderTree, GitBranch, KeyRound, FileText, Bell, Brain, AlertTriangle, Smartphone } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/crisis-detection",      label: "Detecção de Crises",  icon: AlertTriangle },
